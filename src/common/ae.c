...
flea_err_t THR_flea_ae_ctx_t__ctor (flea_ae_ctx_t* ctx__pt, flea_ae_id_t id__t, const flea_u8_t* key__pcu8, flea_al_u16_t key_len__alu16, const flea_u8_t* nonce__pcu8, flea_al_u8_t nonce_len__alu8, const flea_u8_t* header__pcu8, flea_dtl_t header_len__dtl, flea_al_u8_t tag_length__alu8)
{
  ...
  else if(config__pt->ae_mode__t == flea_gcm)
  {
    ...
    FLEA_CCALL(THR_flea_ctr_mode_ctx_t__ctor(&ctx__pt->mode_specific__u.gcm.ctr_ctx__t, config__pt->cipher_id__t, key__pcu8, key_len__alu16, nonce__pcu8, nonce_len__alu8, 4));
    FLEA_CCALL(THR_flea_gcm_setkey(&ctx__pt->mode_specific__u.gcm));
    FLEA_CCALL(THR_flea_gcm_start(&ctx__pt->mode_specific__u.gcm, nonce__pcu8, nonce_len__alu8, header__pcu8, header_len__dtl));
...
flea_err_t THR_flea_ae_ctx_t__update_encryption (flea_ae_ctx_t* ctx__pt, const flea_u8_t* input__pcu8, flea_u8_t* output__pu8, flea_dtl_t input_output_len__dtl )
{
  ...
  {
    FLEA_CCALL(THR_flea_gcm_update(&ctx__pt->mode_specific__u.gcm, input_output_len__dtl, input__pcu8, output__pu8, ENCRYPT));
  }
  FLEA_THR_FIN_SEC_empty();
}
...
static flea_err_t THR_flea_ae_ctx_t__update_decryption_inner (flea_ae_ctx_t* ctx__pt, const flea_u8_t* input__pcu8, flea_dtl_t input_len__dtl, flea_u8_t* output__pu8 )
{
  ...
  {
    FLEA_CCALL(THR_flea_gcm_update(&ctx__pt->mode_specific__u.gcm, input_len__dtl, input__pcu8, output__pu8, DECRYPT));
  }
...
flea_err_t THR_flea_ae_ctx_t__final_encryption (flea_ae_ctx_t* ctx__pt, flea_u8_t* tag__pu8, flea_al_u8_t* tag_len__palu8)
{
  ...
  else
  {
      *tag_len__palu8 = ctx__pt->tag_len__u8;
      gcm_finish(&ctx__pt->mode_specific__u.gcm, tag__pu8, *tag_len__palu8);
  }
...
flea_err_t THR_flea_ae_ctx_t__final_decryption (flea_ae_ctx_t* ctx__pt)
{
  ...
  if(ctx__pt->config__pt->ae_mode__t == flea_eax)
  {
    ...
    FLEA_CCALL(THR_flea_mac_ctx_t__final_verify(&ctx__pt->mode_specific__u.eax.cmac_ctx__t, ctx__pt->buffer__bu8, tag_len__alu8));
  }
  else
  {
    gcm_finish(&ctx__pt->mode_specific__u.gcm, tag__bu8, tag_len__alu8);
