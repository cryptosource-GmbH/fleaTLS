...
flea_err_e THR_flea_test_montgm_mul_comp_n_prime()
{
...
flea_err_e THR_flea_test_montgm_mul_small2()
{
  FLEA_THR_BEG_FUNC();
...
flea_err_e THR_flea_test_montgm_mul_small()
{
  FLEA_THR_BEG_FUNC();
...
flea_err_e THR_flea_test_montgm_mul()
{
  FLEA_THR_BEG_FUNC();
