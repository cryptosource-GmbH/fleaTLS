...
void
flea_cert_path_validator_t__dtor(flea_cert_path_validator_t *chain__pt);

/**
 *
 */
flea_err_t
THR_flea_cert_path_validator_t__ctor_cert(flea_cert_path_validator_t *chain__pt, const flea_u8_t *target_cert__pcu8, flea_al_u16_t target_cert_len__alu16);

flea_err_t
THR_flea_cert_path_validator_t__ctor_cert_ref(flea_cert_path_validator_t *chain__pt, flea_x509_cert_ref_t *target_cert__pt);

void
flea_cert_path_validator_t__disable_revocation_checking(flea_cert_path_validator_t *cert_chain__pt);

flea_err_t
THR_flea_cert_path_validator_t__add_crl(flea_cert_path_validator_t *chain__pt, const flea_ref_cu8_t *crl_der__cprcu8);

flea_err_t
THR_flea_cert_path_validator_t__add_cert_without_trust_status(flea_cert_path_validator_t *chain__pt, const flea_u8_t *cert__pcu8, flea_al_u16_t cert_len__alu16);

flea_err_t
THR_flea_cert_path_validator_t__add_cert_ref_without_trust_status(flea_cert_path_validator_t *chain__pt, const flea_x509_cert_ref_t *cert_ref__pt);
 ...
 */
flea_err_t
THR_flea_cert_path_validator_t__add_trust_anchor_cert(flea_cert_path_validator_t *chain__pt, const flea_u8_t *cert__pcu8, flea_al_u16_t cert_len__alu16);

flea_err_t
THR_flea_cert_path_validator_t__add_trust_anchor_cert_ref(flea_cert_path_validator_t *chain__pt, const flea_x509_cert_ref_t *cert_ref__pt);
 ...
 */
flea_err_t
THR_flea_cert_path_validator__build_and_verify_cert_chain(flea_cert_path_validator_t *cert_chain__pt, const flea_gmt_time_t *time_mbn__pt);
 ...
 */
flea_err_t
THR_flea_cert_path_validator__build_and_verify_cert_chain_and_create_pub_key(flea_cert_path_validator_t *cert_chain__pt, const flea_gmt_time_t *time_mbn__pt, flea_public_key_t *key_to_construct_mbn__pt);


flea_err_t
THR_flea_cert_path_validator__build_and_verify_cert_chain_and_hostid_and_create_pub_key(flea_cert_path_validator_t *cert_chain__pt, const flea_gmt_time_t *time_mbn__pt, const flea_ref_cu8_t *host_id__pcrcu8, flea_host_id_type_e host_id_type, flea_public_key_t *key_to_construct_mbn__pt);
 ...
 */
void
flea_cert_path_validator_t__abort_cert_path_building(flea_cert_path_validator_t *chain__pt);
