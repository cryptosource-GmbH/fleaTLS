...
# endif
  err__t =
    ...
    pkcs8_ecc_key_secp192r1_explicit_params,
    sizeof(pkcs8_ecc_key_secp192r1_explicit_params),
    flea_sha256,
    flea_ecdsa_emsa1
    );
...
# endif
  ...
  err__t =
    THR_flea_test_pkcs8_inner(
    pkcs8_ecc_key_secp384r1_implicit_params,
    sizeof(pkcs8_ecc_key_secp384r1_implicit_params),
    flea_sha256,
    flea_ecdsa_emsa1
    );
