...
void
flea_cert_store_t__dtor(flea_cert_store_t *cert_store__pt);

flea_err_t
THR_flea_cert_store_t__ctor(flea_cert_store_t *cert_store__pt);

flea_err_t
THR_flea_cert_store_t__add_trusted_cert(flea_cert_store_t *cert_store__pt, const flea_u8_t *der_enc_cert__pcu8, flea_al_u16_t der_enc_cert_len__alu16);
 ...
 */
flea_err_t
THR_flea_cert_store_t__add_trusted_to_path_validator(const flea_cert_store_t *cert_store__pct, flea_cert_path_validator_t *cpv__pt);
