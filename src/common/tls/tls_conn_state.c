...
static void flea_tls_conn_state_t__unset_cipher_suite(flea_tls_conn_state_t *conn_state__pt)
{
  ...
  {
    FLEA_FREE_MEM_CHECK_SET_NULL_SECRET_ARR(conn_state__pt->suite_specific__u.cbc_hmac_conn_state__t.cipher_key__bu8, conn_state__pt->cipher_suite_config__t.suite_specific__u.cbc_hmac_config__t.mac_key_size__u8 + conn_state__pt->cipher_suite_config__t.suite_specific__u.cbc_hmac_config__t.cipher_key_size__u8);
  }
...
)
{
  ...
  FLEA_ALLOC_MEM_ARR(conn_state__pt->suite_specific__u.cbc_hmac_conn_state__t.cipher_key__bu8, cipher_key_len__alu8 + mac_key_len__alu8);
  conn_state__pt->suite_specific__u.cbc_hmac_conn_state__t.mac_key__bu8 = conn_state__pt->suite_specific__u.cbc_hmac_conn_state__t.cipher_key__bu8 + cipher_key_len__alu8;
#endif
  ...
  conn_state__pt->cipher_suite_config__t.suite_specific__u.cbc_hmac_config__t.cipher_key_size__u8 = cipher_key_len__alu8;
  ...
  memcpy(conn_state__pt->suite_specific__u.cbc_hmac_conn_state__t.cipher_key__bu8, cipher_key__pcu8, cipher_key_len__alu8);
