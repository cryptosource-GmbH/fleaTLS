 ...
 */
void
flea__xor_bytes_in_place(flea_u8_t *in_out, const flea_u8_t *in2, flea_dtl_t len);
 ...
 */
void
flea__xor_bytes(flea_u8_t *out, const flea_u8_t *in1, const flea_u8_t *in2, flea_dtl_t len);
 ...
 */
flea_u32_t
flea__decode_U32_BE(const flea_u8_t enc[4]);
 ...
 */
void
flea__encode_U32_BE(flea_u32_t to_enc, flea_u8_t res[4]);
 ...
 */
void
flea__encode_U32_LE(flea_u32_t to_enc, flea_u8_t res[4]);
 ...
 */
void
flea__increment_encoded_BE_int(flea_u8_t *ctr_block, flea_al_u8_t ctr_block_len);
 ...
 */
flea_al_u8_t
flea__nlz_uword(flea_uword_t x);
 ...
 */
flea_mpi_ulen_t
flea__get_BE_int_bit_len(const flea_u8_t *enc, flea_mpi_ulen_t enc_len);
