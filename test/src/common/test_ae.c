...
flea_err_t THR_flea_test_ae ()
{
  ...
  const flea_u8_t eax_aes128_key_1[] = { 0xC6, 0x1A, 0x08, 0x51, 0xAB, 0x4E, 0x51, 0x5D, 0x11, 0x52, 0x5B, 0x92, 0xE2, 0xB9, 0xD8, 0x50 };
  const flea_u8_t eax_aes128_nonce_1[] = { 0xC8, 0x25, 0xFC, 0x7C, 0x4D, 0x53, 0x9D, 0xC7, 0x48, 0x87, 0xCE, 0xCC, 0x70, 0x88, 0x4F, 0x37 };
  const flea_u8_t eax_aes128_exp_tag_1 [] = { 0x32, 0xE5, 0x5C, 0xE0, 0xC3, 0xFA, 0xEA, 0x48, 0x16, 0x4B, 0x12, 0x2C, 0x1B, 0xE2, 0x2D, 0x85 };
