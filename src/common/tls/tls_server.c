...
)
{
  ...
  flea_bool_e found_compression_method;
  flea_bool_e client_presented_sec_reneg_fallback_ciph_suite__b = FLEA_FALSE;
 ...
 */
static flea_bool_e flea_tls__is_allowed_cert_type_hlp_fct(
