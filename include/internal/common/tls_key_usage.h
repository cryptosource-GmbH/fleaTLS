...
typedef enum { flea_tls_kex__rsa, flea_tls_kex__psa_psk, flea_tls_kex__ecdh_ecdsa, flea_tls_kex__ecdh_rsa,
               flea_tls_kex__ecdhe_rsa, flea_tls_kex__ecdhe_ecdsa } flea_tls_kex_kex_e;

typedef enum { flea_tls_cl_cert__rsa_sign, flea_tls_cl_cert__ecdsa_sign, flea_tls_cl_cert__rsa_fixed_ecdh,
               flea_tls_cl_cert__ecdsa_fixed_e } flea_tls_client_cert_type_e;
