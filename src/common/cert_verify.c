...
{ 
  ...
  flea_public_key_t key__t = flea_publick_key_t__INIT_VALUE;
...
FLEA_CCALL( THR_flea_x509_verify_signature_with_pub_key(
      &key__t, 
...
/*FLEA_CCALL( THR_flea_x509_verify_signature( // TODO: NEED TO RECOGNIZE SIGN OF MOD AND EXP INTS
      &subject_cert_ref__pt->tbs_sig_algid__t, 
      &issuer_cert_ref__pt->subject_public_key_info__t,
      &subject_cert_ref__pt->tbs_ref__t,
      &sig_content__t,
