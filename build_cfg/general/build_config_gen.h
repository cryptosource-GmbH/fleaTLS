...
# define FLEA_CRT_RSA_WINDOW_SIZE            1    // FBFLAGS__INT_LIST 1 2 3 4 5
# define FLEA_ECC_SINGLE_MUL_MAX_WINDOW_SIZE 1    // FBFLAGS__INT_LIST 1 2 3 4 5
# define FLEA_MAX_CERT_CHAIN_DEPTH           2    // FBFLAGS__INT_LIST 2 3 4 10 20
# define FLEA_CERT_AND_CRL_PREALLOC_OBJ_CNT  1    // FBFLAGS__INT_LIST 1 2 3 4 10 20
# define FLEA_RSA_MAX_KEY_BIT_SIZE           1024 // FBFLAGS__INT_LIST 1024 1536 2048 4096
# define FLEA_ECC_MAX_MOD_BIT_SIZE           160  // FBFLAGS__INT_LIST 160 192 224 256 320 384 521
