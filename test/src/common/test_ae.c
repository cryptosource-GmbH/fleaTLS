...
# ifdef FLEA_HAVE_EAX
  ...
  const flea_u8_t eax_aes128_key_4[]   = {0x25, 0x1A, 0xD4, 0x94, 0xD6, 0x4D, 0xAB, 0x08, 0xB6, 0x6A, 0x96, 0xCB, 0x8C, 0x78, 0x76, 0xA6};
  const flea_u8_t eax_aes128_nonce_4[] = {0xF8, 0x7A, 0x82, 0x5C, 0x39, 0x32, 0x69, 0x49, 0xEB, 0x19, 0xEE, 0x5B, 0xD3, 0x0C, 0xCB, 0xF9};
  ...
  const flea_u8_t eax_aes128_exp_tag_4 [] = {0xE9, 0xE5, 0xE8, 0x12, 0xB6, 0x23, 0xD9, 0xE7, 0x2C, 0x23, 0x51, 0x8F, 0x08, 0x2E, 0xA4, 0x8C};


  // ====================================
  const flea_u8_t eax_aes128_key_5[]      = {0x0B, 0x70, 0x00, 0x3E, 0x77, 0x14, 0x6B, 0x90, 0x3F, 0x06, 0xEF, 0x29, 0x4F, 0xEC, 0xD5, 0x17};
  const flea_u8_t eax_aes128_nonce_5[]    = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F};
  const flea_u8_t eax_aes128_assoc_5[]    = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F};
  const flea_u8_t eax_aes128_pt_5[]       = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F};
  const flea_u8_t eax_aes128_exp_ct_5[]   = {0xC4, 0xBA, 0xD0, 0xE0, 0x35, 0x6F, 0xFD, 0x36, 0x91, 0x10, 0xC0, 0x48, 0xD4, 0x5D, 0x81, 0xBE};
  const flea_u8_t eax_aes128_exp_tag_5 [] = {0xDE, 0x7C, 0x2B, 0x1D, 0x83, 0xBE, 0x2C, 0xC8, 0xEA, 0x40, 0x2A, 0xBE, 0x10, 0x38, 0xBB, 0x79};

  const flea_u8_t eax_aes192_key_1[]   = {0x7c, 0x74, 0xda, 0x83, 0xb1, 0xf2, 0x92, 0xb8, 0x69, 0xc8, 0x91, 0xc8, 0x08, 0x50, 0xe8, 0x5f, 0x82, 0x37, 0x41, 0x2e, 0x13, 0xa0, 0xbf, 0x3f};
  const flea_u8_t eax_aes192_nonce_1[] = {0xcf, 0xab, 0x2c, 0x57, 0x3a, 0x0e, 0x72, 0x36, 0x13, 0xe6, 0xe5, 0xb5, 0x87, 0x87, 0xaf, 0x60};
// const flea_u8_t eax_aes192_assoc_1[]    = {};

  const flea_u8_t eax_aes192_pt_1[]     = {0x75, 0x37, 0xf3, 0xe4, 0xcb, 0xe2, 0x28, 0x46, 0x8a, 0x78, 0x37, 0xc6, 0x6a, 0xec, 0x8a, 0x9b, 0x60, 0x33, 0xcb, 0xa4, 0xf1, 0xb3, 0xd8};
  const flea_u8_t eax_aes192_exp_ct_1[] = {0x98, 0xa5, 0x5f, 0x7d, 0xb5, 0x8f, 0xde, 0x8e, 0xd8, 0xbc, 0x00, 0xc0, 0x1c, 0x97, 0xa6, 0xe5, 0xbd, 0xa1, 0x37, 0xb0, 0x3e, 0x56, 0xe0};
  //
  const flea_u8_t eax_aes192_exp_tag_1 [] = {0xdd, 0xdf, 0xbe, 0x39, 0x6c, 0x44, 0xa1, 0x46, 0x46, 0xcb, 0xc8, 0x99, 0x79, 0xf3, 0x87, 0x36};

  const flea_u8_t eax_aes192_key_2[]      = {0x03, 0xdd, 0x25, 0x86, 0x01, 0xc1, 0xd4, 0x87, 0x2a, 0x52, 0xb2, 0x78, 0x92, 0xdb, 0x03, 0x56, 0x91, 0x1b, 0x2d, 0xf1, 0x43, 0x6d, 0xc7, 0xf4};
  const flea_u8_t eax_aes192_nonce_2[]    = {0x72, 0x3c, 0xb2, 0x02, 0x21, 0x02, 0x11, 0x30, 0x18, 0xdc, 0xd2, 0xd2, 0x04, 0x02, 0x21, 0x14};
  const flea_u8_t eax_aes192_exp_tag_2 [] = {0xc4, 0x72, 0xb1, 0xc6, 0xc2, 0x2b, 0x4f, 0x2b, 0x7e, 0x02, 0x40, 0x94, 0x99, 0xaa, 0x2a, 0xde};

  const flea_u8_t eax_aes192_key_3[]   = {0xd3, 0x3d, 0xda, 0x72, 0x64, 0x95, 0x75, 0xe4, 0x2d, 0x6e, 0xb1, 0xf3, 0x25, 0x5e, 0x68, 0x60, 0x84, 0xb8, 0xa9, 0xcf, 0x44, 0x80, 0x80, 0x3c};
  const flea_u8_t eax_aes192_nonce_3[] = {0xad, 0x2a, 0x1d, 0x2e, 0xf2, 0x36, 0xdf, 0xae, 0xb1, 0x09, 0xab, 0x29, 0xb1, 0x08, 0x4d, 0x63};
  ...
  const flea_u8_t eax_aes192_exp_tag_3 [] = {0x6e, 0xdc, 0x35, 0x8f, 0x22, 0x35, 0x8e, 0x1d, 0x32, 0x8c, 0x4c, 0x1c, 0xd9, 0x81, 0x84, 0xc6};

  const flea_u8_t eax_aes192_key_4[]      = {0x03, 0xdd, 0x25, 0x86, 0x01, 0xc1, 0xd4, 0x87, 0x2a, 0x52, 0xb2, 0x78, 0x92, 0xdb, 0x03, 0x56, 0x91, 0x1b, 0x2d, 0xf1, 0x43, 0x6d, 0xc7, 0xf4};
  const flea_u8_t eax_aes192_nonce_4[]    = {0x02, 0x5f, 0x3d, 0x22, 0x86, 0xc1, 0x43, 0x97, 0x64, 0x12, 0x02, 0x21, 0x02, 0x69, 0x67, 0x08, 0x23, 0x12, 0x08};
  ...
  const flea_u8_t eax_aes192_exp_tag_4 [] = {0x2c, 0xf1, 0xb8, 0x93, 0xae, 0x3b, 0xa8, 0xec, 0xba, 0xc3, 0xa0, 0x8e, 0xa5, 0x7d, 0xe2, 0xcd};


  const flea_u8_t eax_aes192_key_5[]      = {0xa3, 0x6e, 0xed, 0x1c, 0xb5, 0x41, 0x30, 0xf5, 0x47, 0x66, 0x4c, 0x18, 0x4c, 0x24, 0x9e, 0x77, 0x7a, 0x3d, 0x8b, 0xa2, 0xe2, 0x25, 0x1b, 0x58};
  const flea_u8_t eax_aes192_nonce_5[]    = {0xe9, 0x58, 0x78, 0x47, 0xb1, 0xe8, 0x15, 0x11, 0xe0, 0x64, 0x3f, 0x7d, 0xda, 0x5b, 0x72, 0x5c};
  const flea_u8_t eax_aes192_assoc_5[]    = {0x80, 0xc7, 0xcb, 0x95, 0x44, 0x63, 0xb6, 0x06, 0x7b, 0x08, 0x1f, 0xf6, 0x6b, 0x1d, 0x40, 0xcc};
  const flea_u8_t eax_aes192_pt_5[]       = {0x4e, 0x43, 0xdb, 0xeb, 0xe3, 0x16, 0xb7, 0xd6, 0x84, 0xb5, 0x62, 0x36, 0xfd, 0xd9, 0x28, 0xdd};
  const flea_u8_t eax_aes192_exp_ct_5[]   = {0xe2, 0x64, 0x5c, 0xd3, 0x2a, 0x6e, 0x8c, 0x1e, 0x7c, 0xd1, 0x99, 0x1d, 0x87, 0x9b, 0x33, 0x57};
  const flea_u8_t eax_aes192_exp_tag_5 [] = {0x56, 0xf8, 0x48, 0xab, 0xa8, 0xe5, 0x1f, 0x0b, 0x56, 0x71, 0x2b, 0xb2, 0x88, 0x9c, 0x47, 0x83};


  const flea_u8_t eax_aes256_key_2[]      = {0x01, 0x72, 0xac, 0xf2, 0x99, 0x14, 0x2c, 0x00, 0x1d, 0x0c, 0x23, 0x12, 0x87, 0xc1, 0x18, 0x27, 0x84, 0x55, 0x4c, 0xa3, 0xa2, 0x19, 0x08, 0x27, 0x6a, 0xc2, 0xc9, 0x2a, 0xf1, 0x29, 0x46, 0x12};
...
# ifdef FLEA_HAVE_EAX
  ...
  FLEA_CCALL(THR_flea_test_ae_inner(flea_eax_aes128, eax_aes128_key_5, sizeof(eax_aes128_key_5), eax_aes128_nonce_5, sizeof(eax_aes128_nonce_5), eax_aes128_pt_5, sizeof(eax_aes128_pt_5), eax_aes128_exp_tag_5, sizeof(eax_aes128_exp_tag_5), eax_aes128_exp_ct_5, sizeof(eax_aes128_exp_ct_5), eax_aes128_assoc_5, sizeof(eax_aes128_assoc_5), 16));


  FLEA_CCALL(THR_flea_test_ae_inner(flea_eax_aes192, eax_aes192_key_1, sizeof(eax_aes192_key_1), eax_aes192_nonce_1, sizeof(eax_aes192_nonce_1), eax_aes192_pt_1, sizeof(eax_aes192_pt_1), eax_aes192_exp_tag_1, sizeof(eax_aes192_exp_tag_1), eax_aes192_exp_ct_1, sizeof(eax_aes192_exp_ct_1), NULL, 0, 16));

  FLEA_CCALL(THR_flea_test_ae_inner(flea_eax_aes192, eax_aes192_key_2, sizeof(eax_aes192_key_2), eax_aes192_nonce_2, sizeof(eax_aes192_nonce_2), NULL, 0, eax_aes192_exp_tag_2, sizeof(eax_aes192_exp_tag_2), NULL, 0, NULL, 0, 16));

  FLEA_CCALL(THR_flea_test_ae_inner(flea_eax_aes192, eax_aes192_key_3, sizeof(eax_aes192_key_3), eax_aes192_nonce_3, sizeof(eax_aes192_nonce_3), NULL, 0, eax_aes192_exp_tag_3, sizeof(eax_aes192_exp_tag_3), NULL, 0, eax_aes192_assoc_3, sizeof(eax_aes192_assoc_3), 16));

  FLEA_CCALL(THR_flea_test_ae_inner(flea_eax_aes192, eax_aes192_key_4, sizeof(eax_aes192_key_4), eax_aes192_nonce_4, sizeof(eax_aes192_nonce_4), eax_aes192_pt_4, sizeof(eax_aes192_pt_4), eax_aes192_exp_tag_4, sizeof(eax_aes192_exp_tag_4), eax_aes192_exp_ct_4, sizeof(eax_aes192_exp_ct_4), eax_aes192_assoc_4, sizeof(eax_aes192_assoc_4), 16));
...
# ifdef FLEA_HAVE_GCM
  ...
  FLEA_CCALL(THR_flea_test_ae_inner(flea_gcm_aes128, gcm_aes128_key_4, sizeof(gcm_aes128_key_4), gcm_aes128_nonce_4, sizeof(gcm_aes128_nonce_4), gcm_aes128_pt_4, sizeof(gcm_aes128_pt_4), gcm_aes128_exp_tag_4, sizeof(gcm_aes128_exp_tag_4), gcm_aes128_exp_ct_4, sizeof(gcm_aes128_exp_ct_4), gcm_aes128_assoc_4, sizeof(gcm_aes128_assoc_4), 16));

  FLEA_CCALL(THR_flea_test_ae_inner(flea_gcm_aes128, gcm_aes128_key_5, sizeof(gcm_aes128_key_5), gcm_aes128_nonce_5, sizeof(gcm_aes128_nonce_5), gcm_aes128_pt_5, sizeof(gcm_aes128_pt_5), gcm_aes128_exp_tag_5, sizeof(gcm_aes128_exp_tag_5), gcm_aes128_exp_ct_5, sizeof(gcm_aes128_exp_ct_5), gcm_aes128_assoc_5, sizeof(gcm_aes128_assoc_5), 16));
