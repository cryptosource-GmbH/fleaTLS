...
#else // ifdef FLEA_HAVE_SHA384_512
...
#define __FLEA_COMPUTED_MAX_HASH_BLOCK_LEN \
  FLEA_MAX5( \
    __FLEA_MIN_HASH_BLOCK_LEN, \
    __FLEA_MD5_HASH_BLOCK_LEN_SWITCHED, \
    __FLEA_SHA1_HASH_BLOCK_LEN_SWITCHED, \
    __FLEA_SHA224_256_HASH_BLOCK_LEN_SWITCHED, \
    __FLEA_SHA384_512_HASH_BLOCK_LEN_SWITCHED \
  )

#define __FLEA_COMPUTED_MAX_HASH_OUT_LEN \
  FLEA_MAX4( \
    __FLEA_MIN_HASH_OUT_LEN, \
    __FLEA_SHA1_OUT_LEN_SWITCHED, \
    __FLEA_SHA224_256_OUT_LEN_SWITCHED, \
    __FLEA_SHA384_512_OUT_LEN_SWITCHED \
  )

#define __FLEA_COMPUTED_MAX_HASH_CNT_LEN FLEA_MAX(__FLEA_MIN_HASH_CNT_LEN, __FLEA_SHA384_512_HASH_CNT_LEN_SWITCHED)

#define __FLEA_COMPUTED_MAX_HASH_STATE_LEN \
  FLEA_MAX4( \
    __FLEA_MIN_HASH_STATE_LEN, \
    __FLEA_SHA1_HASH_STATE_LEN_SWITCHED, \
    __FLEA_SHA224_256_HASH_STATE_LEN_SWITCHED, \
    __FLEA_SHA384_512_HASH_STATE_LEN_SWITCHED \
  )
...
#else
# define __FLEA_DES_U32_EXPANDED_KEY_LEN_SWITCHED 0
#endif
...
#define __FLEA_COMPUTED_BLOCK_CIPHER_MAX_EXPANDED_KEY_U32_SIZE \
  FLEA_MAX5( \
    __FLEA_AES_U32_EXPANDED_KEY_LEN_SWITCHED, \
    __FLEA_DES_U32_EXPANDED_KEY_LEN_SWITCHED, \
    __FLEA_TDES_2KEY_U32_EXPANDED_KEY_LEN_SWITCHED, \
    __FLEA_TDES_3KEY_U32_EXPANDED_KEY_LEN_SWITCHED, \
    __FLEA_DESX_U32_EXPANDED_KEY_LEN_SWITCHED \
  )

#define __FLEA_COMPUTED_BLOCK_CIPHER_MAX_PLAIN_KEY_LEN \
  FLEA_MAX4( \
    __FLEA_AES_MAX_PLAIN_KEY_LEN_SWITCHED, \
    __FLEA_DESX_PLAIN_KEY_LEN_SWITCHED, \
    __FLEA_TDES_2KEY_PLAIN_KEY_LEN_SWITCHED, \
    __FLEA_TDES_3KEY_PLAIN_KEY_LEN_SWITCHED \
  )
...
#define __FLEA_COMPUTED_MAC_MAX_KEY_LEN \
  FLEA_MAX( \
    __FLEA_COMPUTED_MAX_MAC_CMAC_KEY_SIZE_SWITCHED, \
    __FLEA_COMPUTED_MAX_MAC_HMAC_KEY_SIZE_SWITCHED \
  )
...
#define FLEA_ECC_DP_CONCAT_BYTE_SIZE_FROM_MOD_BIT_SIZE(mod_bit_size) \
  ((((((mod_bit_size) + 7) / 8) * 6) + 2 * (32 / 8) \
  + 1))
...
#define __FLEA_COMPUTED_MAX_INTERNAL_FORMAT_PUBKEY_LEN \
  FLEA_MAX( \
...
#define __FLEA_COMPUTED_PK_MAX_ASYM_PRIVKEY_LEN \
  FLEA_MAX( \
    __FLEA_ECC_MAX_INTERNAL_FORMAT_PRIVKEY_LEN_SWITCHED, \
...
# define __FLEA_ECDSA_MAX_CONCAT_SIG_LEN_SWITCHED FLEA_ECDSA_MAX_CONCAT_SIG_LEN
#else
# define __FLEA_ECDSA_MAX_CONCAT_SIG_LEN_SWITCHED 0
#endif

#define __FLEA_COMPUTED_MAX_ASYM_PLAIN_SIG_LEN \
  FLEA_MAX( \
    __FLEA_ECDSA_MAX_CONCAT_SIG_LEN_SWITCHED, \
    __FLEA_RSA_MAX_SIG_LEN_SWITCHED \
  )

/**
 * excess size of ASN.1 sig compared to concat sig:
 * +3 SEQ TL
 * +2 PREPEND ZERO TO INTS
 * +4 2*INT TL
 * ==
 *  9
 */
#define __FLEA_COMPUTED_ECDSA_MAX_ASN1_SIG_LEN \
  (9 + (__FLEA_ECDSA_MAX_CONCAT_SIG_LEN_SWITCHED))

#define __FLEA_COMPUTED_MAX_ASYM_ENCODED_SIG_LEN \
  (+FLEA_MAX(__FLEA_COMPUTED_ECDSA_MAX_ASN1_SIG_LEN, (5 + __FLEA_RSA_MAX_SIG_LEN_SWITCHED)))
...
#define __FLEA_COMPUTED_ASYM_PRIMITIVE_INPUT_LEN \
  FLEA_MAX( \
    __FLEA_ECDSA_MAX_PRIMITIVE_INPUT_LEN_SWITCHED, \
    __FLEA_RSA_MAX_PRIMITIVE_INPUT_LEN_SWITCHED \
  )
