...
openssl s_server -accept 4444 -CAfile /tmp/cachain.pem -key misc/tools/openssl_tests/ecdsa_tests/ecdsa_secp224r1/certs/ECDSA_SECP224R1_EE.TC.pem.key -cert misc/tools/openssl_tests/ecdsa_tests/ecdsa_secp224r1/certs/ECDSA_SECP224R1_EE.TC.pem.crt
