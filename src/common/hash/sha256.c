...
{
  flea_u32_t t0, t1;
  flea_u32_t a = *a__pu32, b = *b__pu32, c = *c__pu32, d = *d__pu32, e = *e__pu32, f = *f__pu32, g = *g__pu32,
    h = *h__pu32;
...
# endif /* ifdef FLEA_USE_SHA256_ROUND_MACRO */
...
# else /* ifdef FLEA_USE_SHA256_ROUND_MACRO */
  for(i = 0; i < 64; i++)
  {
    flea_u32_t t;
...
} /* THR_flea_sha256_compression_function */
