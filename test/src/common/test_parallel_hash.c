...
flea_err_t THR_flea_test_parallel_hash()
{
  ...
  FLEA_CCALL(THR_flea_tls_parallel_hash_ctx__ctor(&p_hash_ctx, hash_ids, hash_ids_len));

  FLEA_CCALL(THR_flea_hash_ctx_t__update(&hash_ctx_sha256, msg1, sizeof(msg1)));
  FLEA_CCALL(THR_flea_tls_parallel_hash_ctx__update(&p_hash_ctx, msg1, sizeof(msg1)));

  FLEA_CCALL(THR_flea_hash_ctx_t__final(&hash_ctx_sha256, hash_ctx_sha256_out));
  FLEA_CCALL(THR_flea_tls_parallel_hash_ctx__final(&p_hash_ctx, flea_sha256, FLEA_FALSE, p_hash_ctx_sha256_out));
  ...
  FLEA_CCALL(THR_flea_tls_parallel_hash_ctx__dtor(&p_hash_ctx));
  ...
  FLEA_CCALL(THR_flea_hash_ctx_t__final(&hash_ctx_sha256, hash_ctx_sha256_out));
  FLEA_CCALL(THR_flea_tls_parallel_hash_ctx__final(&p_hash_ctx, flea_sha256, FLEA_TRUE, p_hash_ctx_sha256_out));
  ...
  FLEA_CCALL(THR_flea_tls_parallel_hash_ctx__update(&p_hash_ctx, msg2, sizeof(msg2)));
