 ...
 */
flea_err_t
THR_flea_ber_dec_t__ctor(flea_ber_dec_t *dec, flea_data_source_t *source, flea_dtl_t length_limit);
 ...
 */
void
flea_ber_dec_t__dtor(flea_ber_dec_t *dec__pt);
 ...
 */
flea_bool_t
flea_ber_dec_t__has_current_more_data(flea_ber_dec_t *dec__pt);

/**
 * Open a constructed.
 */
flea_err_t
THR_flea_ber_dec_t__open_constructed(flea_ber_dec_t *dec__pt, flea_asn1_tag_t type__t, flea_al_u8_t class_form__alu8);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__open_constructed_optional(flea_ber_dec_t *dec__pt, flea_asn1_tag_t type__t, flea_al_u8_t class_form__alu8, flea_bool_t *found__pb);

flea_err_t
THR_flea_ber_dec_t__open_constructed_optional_cft(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_bool_t *found__pb);
...
flea_err_t
THR_flea_ber_dec_t__open_sequence(flea_ber_dec_t *dec__pt);

/**
 * Open a set.
 */
flea_err_t
THR_flea_ber_dec_t__open_set(flea_ber_dec_t *dec__pt);

/**
 * Close a constructed and verify that there is no more data left in it.
 */
flea_err_t
THR_flea_ber_dec_t__close_constructed_at_end(flea_ber_dec_t *dec__pt);

/**
 * Close a constructed and discard any data potentially left in it.
 */
flea_err_t
THR_flea_ber_dec_t__close_constructed_skip_remaining(flea_ber_dec_t *dec__pt);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__read_value_raw(flea_ber_dec_t *dec__pt, flea_asn1_tag_t type_t, flea_al_u8_t class_form__alu8, flea_u8_t *out_mem__pu8, flea_dtl_t *out_mem_len__pdtl);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__get_ref_to_raw_optional(flea_ber_dec_t *dec__pt, flea_asn1_tag_t type__t, flea_al_u8_t class_form__alu8, flea_u8_t const **raw__cppu8, flea_dtl_t *len__pdtl, flea_bool_t *found_ptr);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__get_ref_to_raw_optional_cft(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_ref_cu8_t *der_ref__t, flea_bool_t *found__pb);

flea_err_t
THR_flea_ber_dec_t__decode_integer_u32_optional(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_u32_t *result__pu32, flea_bool_t *found__pb);

flea_err_t
THR_flea_ber_dec_t__decode_integer_u32_default(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_u32_t *result__pu32, flea_u32_t default__u32);

flea_err_t
THR_flea_ber_dec_t__decode_integer_u32(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_u32_t *result__pu32);

flea_err_t
THR_flea_ber_dec_t__get_der_ref_to_int(flea_ber_dec_t *dec__pt, flea_ref_cu8_t *der_ref__pt);

flea_err_t
THR_flea_ber_dec_t__get_der_ref_to_positive_int_wo_lead_zeroes(flea_ber_dec_t *dec__pt, flea_ref_cu8_t *der_ref__pt);

flea_err_t
THR_flea_ber_dec_t__get_der_ref_to_positive_int_wo_lead_zeroes_optional(flea_ber_dec_t *dec__pt, flea_ref_cu8_t *der_ref__pt);

flea_err_t
THR_flea_ber_dec_t__get_der_ref_to_oid(flea_ber_dec_t *dec__pt, flea_ref_cu8_t *ref__pt);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__get_ref_to_string(flea_ber_dec_t *dec__pt, flea_asn1_str_type_t *str_type_ptr, flea_u8_t const **raw__cppu8, flea_dtl_t *len__pdtl);


flea_err_t
THR_flea_ber_dec_t__get_ref_to_date(flea_ber_dec_t *dec__pt, flea_asn1_time_type_t *time_type__pt, flea_u8_t const **raw__cppu8, flea_dtl_t *len__pdtl);

flea_err_t
THR_flea_ber_dec_t__get_ref_to_date_opt(flea_ber_dec_t *dec__pt, flea_asn1_time_type_t *time_type__pt, flea_u8_t const **raw__cppu8, flea_dtl_t *len__pdtl, flea_bool_t *optional_found__pb);

flea_err_t
THR_flea_ber_dec_t__get_ref_to_implicit_universal_optional(flea_ber_dec_t *dec__pt, flea_al_u8_t outer_tag__alu8, flea_asn1_tag_t encap_type__t, flea_ref_cu8_t *ref__pt);

flea_err_t
THR_flea_ber_dec_t__get_ref_to_implicit_universal_optional_with_inner(flea_ber_dec_t *dec__pt, flea_al_u8_t outer_tag__alu8, flea_asn1_tag_t encap_type__t, flea_ref_cu8_t *ref__pt);

flea_err_t
THR_flea_ber_dec_t__get_ref_to_next_tlv_raw(flea_ber_dec_t *dec__pt, flea_ref_cu8_t *ref__pt);

flea_err_t
THR_flea_ber_dec_t__get_ref_to_next_tlv_raw_optional(flea_ber_dec_t *dec__pt, flea_ref_cu8_t *ref__pt);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__decode_boolean_default(flea_ber_dec_t *dec__pt, flea_bool_t *result__pb);

/**
 * Decode an optional boolean value which defaults to false.
 */
flea_err_t
THR_flea_ber_dec_t__decode_boolean_default_false(flea_ber_dec_t *dec__pt, flea_bool_t *result__p);


flea_err_t
THR_flea_ber_dec_t__read_value_raw_cft(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_u8_t *out_mem__pu8, flea_dtl_t *out_mem_len__pdtl);

flea_err_t
THR_flea_ber_dec_t__read_value_raw_cft_opt(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_u8_t *out_mem__pu8, flea_dtl_t *out_mem_len__pdtl, flea_bool_t *optional_found__pb);

flea_err_t
THR_flea_ber_dec_t__get_ref_to_raw_cft(flea_ber_dec_t *dec__pt, flea_asn1_tag_t cft, flea_ref_cu8_t *ref__pt);


flea_bool_t
flea_ber_dec__are_der_refs_equal(const flea_ref_cu8_t *a__pt, const flea_ref_cu8_t *b__pt);
 ...
 */
flea_err_t
THR_flea_ber_dec_t__decode_short_bit_str_to_u32_optional(flea_ber_dec_t *dec__pt, flea_u32_t *val__pu32, flea_al_u8_t *nb_bits__palu8, flea_bool_t *optional_found__pb);

flea_al_u8_t
flea_ber_dec_t__get_nb_bits_from_bit_string(const flea_ref_cu8_t *bit_string__pt);

/**
 * throws if there are unused bits
 */
flea_err_t
THR_flea_ber_dec__get_ref_to_bit_string_content_no_unused_bits(const flea_ref_cu8_t *raw_bit_str__pt, flea_ref_cu8_t *content__pt);

flea_bool_t
flea_ber_dec__is_tlv_null(const flea_ref_cu8_t *ref__pt);
