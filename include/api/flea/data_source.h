...
typedef flea_err_t (* flea_data_source_read_f)(
  void*       custom_obj__pv,
  flea_dtl_t* nb_bytes_to_read__pdtl,
  flea_u8_t*  target_buffer__pu8
);
typedef flea_err_t (* flea_data_source_skip_f)(
  void*      custom_obj__pv,
...
flea_bool_t flea_data_source_t__is_memory_data_source(
  const flea_data_source_t* source__pt
);
