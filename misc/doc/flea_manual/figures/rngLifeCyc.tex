...
\draw[myarrow] (stateSix.west) -| node[midway, above, align=left] {\code{flea\_prng\_}\\\code{save\_f}} (seedFile.south);
...
\node[node distance = 0.7cm, below = of app] (initSeed) { intial seed value};

%\draw[dashed] ($(funcZero.north east)+(0.5,4.5)$) -- ($(funcSix.south east) + (0.5,-1.5)$);
\coordinate (initSep) at ($(initSeed) + (2,-0.5)$);
\node[align=left] at ($(initSep) + (1,0)$) { end of\\ initialization\\ phase };
\draw[dashed] (initSep) -- ($(initSep) - (17,0)$);
