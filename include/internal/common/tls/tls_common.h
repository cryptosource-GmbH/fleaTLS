...
typedef enum
{
  ...
  FLEA_TLS_HANDSHAKE_EXPECT_HELLO_VERIFY_REQUEST = 0x1000
...
flea_err_e THR_flea_tls_ctx_t__flush_write_app_data(flea_tls_ctx_t* tls_ctx) FLEA_ATTRIB_UNUSED_RESULT;
