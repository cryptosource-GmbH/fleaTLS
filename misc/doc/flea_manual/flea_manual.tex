...
\usepackage[margin=2.0cm,tmargin=2.9cm,bmargin=3.5cm,headsep=1.7cm]{geometry}
...
\fancyhead[R]{\hspace{-1.9cm}\includegraphics[width=4.5cm]{cs_logo.eps}}
\fancyhead[L]{
...
\begin{itemize}
  ...
  \verb#build\_cfg/pltf\_spec/32bit\_default/build\_cfg\_pltf.h#, making it easy to configure the
